...
public class CalculatorStepDefs {
	...
	int num2;
	int actResult;
	List<Integer> numbers; // List is used bcoz, in future additional numbers can also be added.
	...
	public void i_do_the_checkout_with_the_given_quantity() {
	...
	for (int i=0; i<rows ; i++)
	{
		...
		int qnty = Integer.parseInt(dataTable.cell(i, 1));
		int value =  Integer.parseInt(dataTable.cell(i, 2));
		
		actBill = actBill + qnty*value;
	}
