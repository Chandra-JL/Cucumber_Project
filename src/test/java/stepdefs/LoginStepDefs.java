...
WebDriver driver = Hooks.driver;
	...
	public void i_click_on_the_Login_link() {
		...
		LoginLink.click();
		Hooks.test.log(LogStatus.PASS, "Clicked login link");
	}
	...
	public void i_enter_the_user_name() {
		...
		Hooks.test.log(LogStatus.PASS, "Entered Username");
	}
	...
	public void i_enter_the_password() {
		...
		Hooks.test.log(LogStatus.PASS, "Entered password");
	}
	...
	public void i_enter_the_user_name_as(String UserNameVal) {
	    // Write code here that turns the phrase above into concrete actions
		WebElement UserName = driver.findElement(By.name("user_login"));
